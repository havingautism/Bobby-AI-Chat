...
本项目采用知识共享署名-非商业性使用-相同方式共享 4.0 国际许可协议。详情请参阅 [LICENSE](LICENSE) 文件。

### 许可证特点

- **非商业性** - 禁止商业使用，保护您的商业权益
- **署名要求** - 他人使用时必须注明原作者
- **强制开源** - 衍生作品必须以相同许可证发布
- **个人自由** - 您可以自由进行个人商业使用
...
1. **分享自由** - 可以自由复制、分发、展示作品
2. **改编自由** - 可以重混、转换、基于作品创作
3. **署名要求** - 必须给出适当的署名和许可证链接
4. **非商业性** - 不得用于商业目的
5. **相同方式共享** - 衍生作品必须使用相同许可证
